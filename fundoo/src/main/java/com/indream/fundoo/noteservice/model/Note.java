...
public class Note implements Serializable {
	...
	public Note(String title, String contents, Date creadtedOn, Date lastModified, String userId) {
		super();
		this.title = title;
	...
	public Note(String title, String contents, Date creadtedOn, Date lastModified) {
		this.title = title;
		this.contents = contents;
		this.creadtedOn = creadtedOn;
		this.lastModified = lastModified;
