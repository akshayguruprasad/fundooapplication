...
public class NoteController {
	...
	public ResponseEntity<NoteResponse> createNote(@RequestBody NoteEntityDTO noteEntityDTO,
	...
	public ResponseEntity<NoteResponse> updateNote(@RequestBody NoteEntityDTO noteEntityDTO,
			HttpServletRequest request) {
		String token = request.getHeader("authorization");
		noteService.updateNote(noteEntityDTO.getId().toString(), noteEntityDTO.getContents(), token);
